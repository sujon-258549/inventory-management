...
const UserDetail = () => {
    ...
    const { _id, email, number, name } = useLoaderData()
    ...
    const handleContactFormSubmit = async (e) => {
        e.preventDefault();
        const response = await axios.patch(`https://inventory-management-one-psi.vercel.app/updateuser/${_id}`, { role });
        ...
        <div className="pb-10">
            <div className="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
                <div className="flex flex-col-reverse items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                    <div>
                        <h1 className="text-4xl font-bold text-white font-playfair">{name}</h1>
                        ...
                        <ul className="mt-12 space-y-8">
                            ...
                            <li className="flex items-center">
                                <FaPhone className="text-white rotate-[100deg]" size={16} />
