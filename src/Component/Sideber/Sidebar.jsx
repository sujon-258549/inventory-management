...
const Sidebar = () => {
  ...
  const [isUserrole, isLoading] = UseUserrole();

  return (
    <section className="flex sodber gap-5 pt-20 relative min-h-screen">
      {isLoading && <Loding />}
      <nav
        className={`bg-white shadow-xl top-16 ${
          isSidebarOpen ? "left-0" : "left-[-400px]"
        } absolute lg:static lg:top-0 lg:left-0 min-w-[250px] py-6 font-[sans-serif] overflow-auto lg:block`}
        style={{ transition: "left 1s", zIndex: "990" }}
      >
        <div className="relative flex flex-col h-full ">
          <button
            onClick={() => setIsSidebarOpen(!isSidebarOpen)}
            className="flex justify-end pr-2 block lg:hidden"
          >
            <RxCross2 className="border-black text-3xl border rounded-full p-1" />
          </button>
          <a href="javascript:void(0)" className="text-center">
            <img src="/bashboad.jpg" alt="logo" className="w-[160px] inline" />
          </a>
          ...
          <ul className="space-y-3 my-8 flex-1 min-h-screen">
              ...
              <>
                ...
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <Link
                    ...
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdAssessment /> Dashboard
                  </Link>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                ...
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    ...
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <FaSellcast /> All Sellar
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/getsupervisorpost"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> All Product
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/getselproduct"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <FaCartShopping /> Sale Product
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/selproduct"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <FaCartShopping /> Add Sale Product
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/allnotice"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> All Notice
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    ...
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> All Contact Info
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    ...
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> Creat Notice
                  </NavLink>
                </li>
              </>
            )}
            {isMarketing && (
              <>
                ...
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/markatingetpost"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <FaSellcast /> Admin Notice
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                ...
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/getmarkatingsuperviserpost"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> Supervisor Notice
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/workernotice"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> Worker Notice
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
            ...
            {isSupervisor && (
              <>
                ...
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    to={"/dashboard/supervisorgetpost"}
                    href="javascript:void(0)"
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <FaSellcast /> Admin Notice
                ...
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
                    ...
                    className="flex items-center text-xl font-playfair gap-2 hover:text-[#007bff] text-gray-500 block font-semibold text-[15px]"
                  >
                    <MdNotificationAdd /> Creat Product post
                  </NavLink>
                </li>
                <li className="max-lg:border-b border-gray-300 max-lg:py-3 px-3">
                  <NavLink
      ...
      <div className="w-full lg:w-[70%] min-h-screen px-5">
        <div
          className={` pt-5 md:pt-10  ${
            isSidebarOpen
              ? ""
              : "flex justify-between items-center lg:justify-center"
          } mx-auto`}
        >
          <div
          ...
          <h1 className="text-2xl md:text-4xl lg:text-6xl font-bold font-playfair text-center ">
            {isUserrole?.role.charAt(0).toUpperCase() +
              isUserrole?.role.slice(1)}{" "}
            Dashboard
          </h1>
        </div>
