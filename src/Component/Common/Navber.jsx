                ...
                <div className="flex max-lg:ml-auto space-x-3">

                    {
                        ...
                        >
                            ...
                            ></div>
                            <span className="inline-flex items-center text-xl font-playfair animate-gradient whitespace-pre bg-gradient-to-r from-[#ffaa40] via-[#9c40ff] to-[#ffaa40] bg-[length:var(--bg-size)_100%] bg-clip-text text-transparent [--bg-size:300%]">
                                Login out
