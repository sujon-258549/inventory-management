...
import Allsuppperviser from "../Sideber/Admin/Allsuppperviser";
import Allworker from "../Sideber/Admin/Allworker";
import Allmarketing from "../Sideber/Admin/Allmarketing";
import CreateNotice from "../Sideber/Admin/CreateNotice";
...
import Allnotice from "../Sideber/Admin/Allnotice";
import Supervisernotice from "../Sideber/Supervisor/Supervisernotice";
import Contact from "../signuplogin/Contact";
import Allcontactinfo from "../Sideber/Admin/Allcontactinfo";
import SideberHome from "../Sideber/SideberHome";
import AboutUs from "../Home/AboutUs";
import Detail from "../Sideber/Admin/Detail";
import UserDetail from "../Sideber/Admin/UserDetail";
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loader: ({ params }) =>
              fetch(
                `https://inventory-management-one-psi.vercel.app/contactdetailpage/${params.id}`
              ),
          },
          {
            ...
            loader: ({ params }) =>
              fetch(
                `https://inventory-management-one-psi.vercel.app/detailuser/${params.id}`
              ),
          },
          {
            ...
            loader: ({ params }) =>
              fetch(
                `https://inventory-management-one-psi.vercel.app/singalgetproduct/${params.id}`
              ),
          },
          {
            // dingle get product
            ...
            loader: ({ params }) =>
              fetch(
                `https://inventory-management-one-psi.vercel.app/getselproductid/${params.id}`
              ),
          },
          {
